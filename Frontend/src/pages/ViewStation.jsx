    ...
    <div className="min-h-screen bg-[#F8FAFC] p-4 sm:p-6 lg:p-10 font-sans selection:bg-teal-500/30 overflow-hidden relative">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="mt-8 flex justify-center pb-8">
          <Link to="/" className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-teal-600 transition-colors px-5 py-3 rounded-xl hover:bg-slate-200/50 border border-transparent hover:border-slate-300/50 shadow-[0_4px_15px_rgb(0,0,0,0.03)] bg-white/60 backdrop-blur-md">
